    ...
    <div className="scoreboard-panel w-full rounded-[1.75rem] bg-white px-3 py-2.5 shadow-sm md:px-4 md:py-3">
      <div className="scoreboard-stats mb-2 grid grid-cols-2 gap-2 md:grid-cols-4">
        ...
        >
          ...
          <div className="scoreboard-badge-copy mt-1 text-[11px] font-extrabold text-amber-900">
            {showBadges ? 'Hide' : 'Open'}
          </div>
        </button>
      </div>

      {showBadges && (
        <div className="scoreboard-badges mt-2 max-h-44 overflow-y-auto">
